...
#define RUBY_VM_THREAD_VM_STACK_SIZE          ( 0.75 * 1024 * sizeof(VALUE)) /*  512 KB or 1024 KB */ // VM の方
#define RUBY_VM_THREAD_VM_STACK_SIZE_MIN      (   0.5 * 1024 * sizeof(VALUE)) /*    8 KB or   16 KB */
#define RUBY_VM_THREAD_MACHINE_STACK_SIZE     ( 12 * 1024 * sizeof(VALUE)) /*  512 KB or 1024 KB */ // C の方
#define RUBY_VM_THREAD_MACHINE_STACK_SIZE_MIN (  1 * 1024 * sizeof(VALUE)) /*   64 KB or  128 KB */
...
// add
#define RUBY_VM_END_NEW_CONTROL_FRAME(th) th->new_stack_end
#define RUBY_VM_CONTROL_FRAME_NEW_STACK_OVERFLOW_P(th, cfp) \
  (!RUBY_VM_VALID_CONTROL_FRAME_P((cfp), RUBY_VM_END_NEW_CONTROL_FRAME(th))) // th->cfp より RUBY_VM_END_NEW_CONTROL_FRAME の可能性
// end
...
#define CHECK_VM_STACK_OVERFLOW0(cfp, sp, margin,th) \
    WHEN_VM_STACK_OVERFLOWED(cfp, sp, margin)  /*vm_stackoverflow()*/ dummy(cfp,sp,margin,th)// dummy => vm_stackoverflow()
